...
func _000004_commentDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000004_comment.down.sql", size: 24, mode: os.FileMode(420), modTime: time.Unix(1602415764, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000004_commentUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000004_comment.up.sql", size: 163, mode: os.FileMode(420), modTime: time.Unix(1602415764, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
